...
<div class="container mt-5">
    <h2 class="mb-4 fw-bold text-center">Liste des demandes</h2>

    <div class="card shadow-sm border-0 rounded-4 p-4">

        <!-- Recherche et filtre -->
        <div class="d-flex flex-wrap justify-content-between mb-4">
            <input type="text" id="searchInput" class="form-control w-50 shadow-sm rounded-3 mb-2" placeholder="Rechercher par nom, prénom ou CIN...">

            <select id="sourceFilter" class="form-select w-auto shadow-sm rounded-3 mb-2">
                <option value="all">filtrer demande saisie</option>
...
<th>Demande saisir par</th>
                ...
                <tbody id="demandesTable">
                    ...
                    <tr data-source="{{ $demande->is_online ? 'client' : 'agence' }}">
                        ...
                        <td>
                            @php
                                $statusLabels = ['en_attente' => 'En attente', 'en_cours' => 'En cours'];
    ...
    <span class="badge {{ $demande->is_online ? 'bg-success' : 'bg-secondary' }}">
        {{ $demande->is_online ? 'Client en ligne' : 'Agence' }}
    </span>
</td>
    ...
    <form method="POST" action="" id="affecterForm">
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Affecter un traducteur</h5>
